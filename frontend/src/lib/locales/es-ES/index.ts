export const esES = {
  ...
  multiChat: {
    title: "Chat Multi-Cuaderno",
    description: "Selecciona cuadernos y chatea con todo su contenido a la vez",
    configureNotebooks: "Seleccionar cuadernos",
    noNotebooks: "No hay cuadernos disponibles. Crea uno primero.",
    selectNotebooksFirst: "Selecciona al menos un cuaderno para empezar a chatear",
    chatTitle: "Chat",
