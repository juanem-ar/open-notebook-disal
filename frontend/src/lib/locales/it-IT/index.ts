export const itIT = {
  ...
  multiChat: {
    title: "Chat multi-quaderno",
    description: "Seleziona quaderni e chatta con tutto il contenuto",
    configureNotebooks: "Seleziona quaderni",
    noNotebooks: "Nessun quaderno disponibile. Creane uno prima.",
    selectNotebooksFirst: "Seleziona almeno un quaderno per iniziare",
    chatTitle: "Chat",
