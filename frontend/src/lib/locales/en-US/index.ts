export const enUS = {
  ...
  multiChat: {
    title: "Multi-Notebook Chat",
    description: "Select notebooks and chat across all their content at once",
    configureNotebooks: "Select Notebooks",
    noNotebooks: "No notebooks available. Create a notebook first.",
    selectNotebooksFirst: "Select at least one notebook to start chatting",
    chatTitle: "Chat",
    selected: "selected",
