export const ruRU = {
  ...
  navigation: {
    ...
    sources: "Источники",
    notebooks: "Блокноты",
    multiChat: "Мульти-чат блокнотов",
  ...
  multiChat: {
    title: "Мульти-чат блокнотов",
    description: "Выберите блокноты и общайтесь со всем их содержимым",
    configureNotebooks: "Выбрать блокноты",
    noNotebooks: "Нет доступных блокнотов. Сначала создайте один.",
    selectNotebooksFirst: "Выберите хотя бы один блокнот для начала чата",
    chatTitle: "Чат",
    selected: "выбрано",
