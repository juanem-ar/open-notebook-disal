export const bnIN = {
  ...
  multiChat: {
    title: "মাল্টি-নোটবুক চ্যাট",
    description: "নোটবুক নির্বাচন করুন এবং সব কন্টেন্ট দিয়ে চ্যাট করুন",
    configureNotebooks: "নোটবুক নির্বাচন করুন",
    noNotebooks: "কোনো নোটবুক পাওয়া যায়নি। প্রথমে একটি তৈরি করুন।",
    selectNotebooksFirst: "চ্যাট শুরু করতে কমপক্ষে একটি নোটবুক নির্বাচন করুন",
    chatTitle: "চ্যাট",
    selected: "নির্বাচিত",
