export const ptBR = {
  ...
  multiChat: {
    title: "Chat multi-caderno",
    description: "Selecione cadernos e converse com todo o conteúdo de uma vez",
    configureNotebooks: "Selecionar cadernos",
    noNotebooks: "Nenhum caderno disponível. Crie um primeiro.",
    selectNotebooksFirst: "Selecione pelo menos um caderno para começar",
    chatTitle: "Chat",
