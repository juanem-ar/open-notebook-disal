export const jaJP = {
  ...
  multiChat: {
    title: "マルチノートブックチャット",
    description: "ノートブックを選択してすべてのコンテンツと会話する",
    configureNotebooks: "ノートブックを選択",
    noNotebooks: "利用可能なノートブックがありません。まず作成してください。",
    selectNotebooksFirst: "チャットを開始するにはノートブックを選択してください",
    chatTitle: "チャット",
    selected: "選択済み",
