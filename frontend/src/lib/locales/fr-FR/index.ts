export const frFR = {
  ...
  multiChat: {
    title: "Chat multi-carnets",
    description: "Sélectionnez des carnets et discutez avec tout leur contenu",
    configureNotebooks: "Sélectionner des carnets",
    noNotebooks: "Aucun carnet disponible. Créez-en un d'abord.",
    selectNotebooksFirst: "Sélectionnez au moins un carnet pour commencer",
    chatTitle: "Chat",
